...
class Parser:
    ...
    def factor(self):
        ...
        # Verifica se o token atual é um parêntese de abertura
...
# Função para rodar o lexer e o parser
def run(fn, text):
    # Geração dos Tokens
    lexer = Lexer(fn, text)
    ...
    # Geração da Árvore de Sintaxe Abstrata, ou AST
